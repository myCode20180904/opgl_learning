...
(function (LESSONS) {
    ...
    var lesson5 = (function () {
        function lesson5() {
            this.modelMatrix = new Matrix4(0); // 模型矩阵
            this.viewMatrix = new Matrix4(0); // 视点矩阵
            this.projMatrix = new Matrix4(0); // 投影矩阵
            this.mvpMatrix = new Matrix4(0); // 用于相乘用
            this.angle = 0;
            LESSONS._watcher.name = "第五课 初识Shader";
            /**
        ...
        lesson5.prototype.draw = function () {
            ...
            var _mvpMatrix = this.mvpMatrix.elements;
            // 赋值
